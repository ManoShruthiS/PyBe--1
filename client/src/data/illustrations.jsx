...
const ILLUSTRATION_MAP = {
  ...
  'e-syn-1': () => <ComicImage id="e-syn-1" FallbackSVG={RoomOrganizerIllustration} alt="Room Organizer" />,
  'e-syn-2': () => <ComicImage id="e-syn-2" FallbackSVG={MorningGreetingIllustration} alt="Morning Greeting" />,
  'e-syn-3': () => <ComicImage id="e-syn-3" FallbackSVG={FruitBasketIllustration} alt="Fruit Basket" />,
  'e-syn-4': () => <ComicImage id="e-syn-4" FallbackSVG={ScoreCalculatorIllustration} alt="Score Calculator" />,
  'e-run-1': () => <ComicImage id="e-run-1" FallbackSVG={ColorPaletteIllustration} alt="Color Palette" />,
  'e-run-2': () => <ComicImage id="e-run-2" FallbackSVG={ContactCardIllustration} alt="Contact Card" />,
  'e-run-3': () => <ComicImage id="e-run-3" FallbackSVG={TextEditorIllustration} alt="Text Editor" />,
  'e-run-4': () => <ComicImage id="e-run-4" FallbackSVG={DiaryReaderIllustration} alt="Diary Reader" />,
  'e-run-5': () => <ComicImage id="e-run-5" FallbackSVG={ToolboxIllustration} alt="Toolbox" />,
  'e-run-6': () => <ComicImage id="e-run-6" FallbackSVG={ClockAppIllustration} alt="Clock App" />,
  'e-log-1': () => <ComicImage id="e-log-1" FallbackSVG={VotingCounterIllustration} alt="Voting Counter" />,
  'e-log-2': () => <ComicImage id="e-log-2" FallbackSVG={EndlessMeetingIllustration} alt="Endless Meeting" />,
  'e-log-3': () => <ComicImage id="e-log-3" FallbackSVG={InventoryCheckIllustration} alt="Inventory Check" />,
  'e-log-4': () => <ComicImage id="e-log-4" FallbackSVG={ClubEntryIllustration} alt="Club Entry" />,
  'e-log-5': () => <ComicImage id="e-log-5" FallbackSVG={ShoppingBillIllustration} alt="Shopping Bill" />,
